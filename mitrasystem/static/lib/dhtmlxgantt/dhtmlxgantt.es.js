...
dhtmlxGantt v.9.0.10 Professional Evaluation
...
function Ut(t) {
  ...
  for (e.sort(function(r, o) {
    ...
    var a = e[i];
    (ci(a) || hi(a) || ui(a)) && di(a) || (e.splice(i, 1), i--);
  }
  return e;
}
function En() {
...
const Nn = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: xt, closest: ut, getActiveElement: De, getChildNodes: An, getClassName: it, getClosestSizedElement: In, getFocusableNodes: Ut, getNodePosition: J, getRelativeEventPosition: ct, getRelativeNodePosition: Mn, getRootNode: Dt, getScrollSize: En, getTargetNode: At, hasClass: function(t, n) {
  return "classList" in t ? t.classList.contains(n) : new RegExp("\\b" + n + "\\b").test(t.className);
}, hasShadowParent: function(t) {
  return !!Dt(t);
}, insertNode: Cn, isChildOf: et, isShadowDomSupported: Ln, locateAttribute: tt, locateClassName: yt, removeClassName: Nt, removeNode: Dn, toNode: We }, Symbol.toStringTag, { value: "Module" })), Q = typeof window < "u" ? window : global;
let _i = class {
  constructor(t) {
...
function gt(t) {
  ...
  t.attachEvent = function(e, i, a) {
    e = "ev_" + e.toLowerCase(), n.listeners[e] || (n.listeners[e] = function(o) {
      var s = {}, l = 0, d = function() {
        var u = !0;
        for (var c in s) {
          var h = s[c].apply(o, arguments);
          u = u && h;
        }
        return u;
      };
...
function K(t) {
  ...
  if (t && typeof t == "object") switch (!0) {
    ...
    default:
      ...
      for (n in t) Object.prototype.hasOwnProperty.apply(t, [n]) && (e[n] = K(t[n]));
  }
  return e || t;
}
function R(t, n, e) {
...
const On = Object.freeze(Object.defineProperty({ __proto__: null, bind: B, copy: K, defined: G, event: Rn, eventRemove: Hn, mixin: R, uid: ht }, Symbol.toStringTag, { value: "Module" }));
function Ve(t, n) {
  t = t || Rn, n = n || Hn;
...
const $i = { auto_scheduling: function(t) {
  ...
  function l(u, c, h) {
    ...
    for (let f = 0; f < u.length; f++) {
      const k = u[f];
      for (let v = 0; v < k.commands.length; v++) k.commands[v].entity === _.command.entity.task ? r(k.commands[v], c, h) : k.commands[v].entity === _.command.entity.link && s(k.commands[v], c, h);
    }
  }
  function d(u, c, h) {
    const _ = n;
...
} }, dn = { date_to_str: (t, n, e) => (i) => t.replace(/%[a-zA-Z]/g, (a) => {
  switch (a) {
    case "%d":
...
function wi(t) {
  ...
  var i = { init: function() {
    ...
    var o = ln;
    return e() && (o = dn), o.date_to_str(a, r, t);
  }, str_to_date: function(a, r) {
    var o = ln;
    return e() && (o = dn), o.str_to_date(a, r, t);
...
const Ai = { create: function() {
  var t = R({}, { createDatastore: function(n) {
    var e = (n.type || "").toLowerCase() == "treedatastore" ? Ue : lt;
    if (n) {
      var i = this;
...
function zi(t) {
  ...
  var e = "auto", i = "singleValue", a = "valueArray", r = "resourceValueArray", o = "assignmentsArray", s = e, l = "fixedDates", d = "fixedDuration", u = "default";
  function c(p, y) {
  ...
  function _(p, y) {
    ...
    return p.mode === d ? (w = t.calculateEndDate({ start_date: $, duration: p.duration, task: y }), x = p.duration) : (w = new Date(y.end_date), x = y.duration - p.delay), { start_date: $, end_date: w, duration: x };
  }
  function f(p) {
...
var ue = function(t, n, e, i) {
  this.$config = R({}, n || {}), this.$gantt = i, this.$parent = t, gt(this), this.$state = {}, R(this, Un(this));
};
function Yi(t) {
  function n(e) {
...
ue.prototype = { init: function(t) {
  ...
  var l = function(u, c) {
    var h = { column_before_start: u.bind(function(_, f, k) {
      ...
      if (w < x && (w = x), v.keep_grid_width) {
        ...
        if (c.$grid_data.offsetWidth <= M - 25) for (E = m + 1; E < g.length; E++) I += g[E].width;
        else {
  ...
  var d = function(u, c) {
    var h = { row_before_start: u.bind(function(_, f, k) {
      ...
      c.callEvent("onBeforeRowResizeEnd", [g, m, y]) !== !1 && m.row_height != y && (m.row_height = y, v.updateItem(g), c.callEvent("onAfterRowResize", [g, m, p, y]), this.render());
    }, u) };
    return { init: function() {
  ...
  for (var u = 0; u < a.length; u++) {
    ...
    c && f > o + _ && (h.width = _ = f - o), o += _;
    var k = t._sort && h.name == t._sort.name ? `<div data-column-id="${h.name}" class="gantt_sort gantt_${t._sort.direction}"></div>` : "", v = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, c ? "gantt_last_cell" : "", i.grid_header_class(h.name, h)].join(" "), b = "width:" + (_ - (c ? 1 : 0)) + "px;", g = h.label || s["column_" + h.name] || s[h.name];
    typeof g == "function" && (g = g.call(t, h.name, h)), g = g || "";
    let p = !1;
    t.config.external_render && t.config.external_render.isElement(g) && (p = !0, d[h.name] = g);
...
const ia = (t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1747550704000 > "u")) {
      var e, i;
      setInterval(() => {
        Date.now() - 1747550704000 > 5184e6 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
...
`);
    if (typeof 1747550704000 > "u") return;
    const e = function() {
      var i, a;
      setTimeout(() => {
        Date.now() - 1747550704000 > 7776e6 && window.alert(n), e();
...
function Ba() {
  this.constants = xi, this.version = "9.0.10", this.license = "evaluation", this.templates = {}, this.ext = {}, this.keys = { edit_save: this.constants.KEY_CODES.ENTER, edit_cancel: this.constants.KEY_CODES.ESC };
}
function za(t) {
  ...
  n.plugins = function(l) {
    ...
    return { cache: !0, method: "get", parse: function(d) {
      return typeof d != "string" ? d : (d = d.replace(/^[\s]+/, ""), typeof DOMParser > "u" || bt.isIE ? Q.ActiveXObject !== void 0 && ((u = new Q.ActiveXObject("Microsoft.XMLDOM")).async = "false", u.loadXML(d)) : u = new DOMParser().parseFromString(d, "text/xml"), u);
      var u;
  ...
  var r = /* @__PURE__ */ function(l) {
    ...
    return { initTemplates: function() {
      ...
      }, tooltip_date_format: c.date_to_str("%Y-%m-%d"), tooltip_text: function(v, b, g) {
  ...
  o.registerProvider("global", function() {
    ...
    l.ext || (l.ext = {});
    for (var d = [Ri, Hi, Bi, zi, ji, Fi, Wi, Vi, Ui], u = 0; u < d.length; u++) d[u] && d[u](l);
  }(n), function(l) {
    (function(d) {
...
function Xn(t, n, e, i, a) {
  ...
  var c = e.posFromDate(r.start_date), h = e.posFromDate(r.end_date), _ = e.posFromDate(o.start_date), f = e.posFromDate(o.end_date);
  if (c > h) {
    var k = h;
    h = c, c = k;
  }
  return _ > f && (k = f, f = _, _ = k), c += -100, h += 100, _ += -100, f += 100, !(n.x > h && n.x > f) && !(n.x_end < c && n.x_end < _);
}
function qa(t, n) {
  if (t.view) {
    var e = t.view;
...
var wt = function() {
  function t(n, e, i, a) {
    n && (this.$container = We(n), this.$parent = n), this.$config = R(e, { headerHeight: 33 }), this.$gantt = a, this.$domEvents = a._createDomEventScope(), this.$id = e.id || "c" + ht(), this.$name = "cell", this.$factory = i, this.$externalComponent = null, gt(this);
  }
    ...
    if ((h.static_background || h.timeline_placeholder) && document.createElement("canvas").getContext) {
      ...
      var v = function(p) {
        ...
        for (var C in S) {
          ...
          if (!r(M)) {
            var I = l(D, T, p);
            s(M, I), E += "." + d(M) + "{ background-image: url('" + I + "');}";
          }
          $[C] = d(M);
        }
        return E && (function() {
...
var Je = function(t, n, e, i) {
  this.$config = R({}, n || {}), this.$scaleHelper = new Fn(i), this.$gantt = i, this._posFromDateCache = {}, this._timelineDragScroll = null, R(this, Un(this)), gt(this);
};
function ye(t) {
...
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
    ...
    return ($ || S) && (d.drag_resize && !t.isSummaryTask(r) && c != d.types.milestone && a(b, "gantt_task_drag", r, function(T) {
      var E = document.createElement("div");
      ...
      var D = !1;
      return x.link_source_id && d.touch && (D = !0), C.style.display = D ? "block" : "", E.appendChild(C), E;
    }, d, _)), b;
  }
  function e(r, o, s, l) {
    if (!o) return null;
...
function br(t) {
  ...
  return { render: function(l, d, u, c) {
    ...
    for (var g = !!c, m = Ct(_, c), p = m.start; p <= m.end; p++) {
      var y = f[p];
      if (y && (!g || Vt(p, _, c, t))) {
    ...
    var _ = u.$getTemplates(), f = u.getScale(), k = n(l, c.resource_property, f, u), v = l.capacity || u.$config.capacity || 24, b = {}, g = !!h, m = Ct(f, h), p = {};
...
function xr(t) {
  ...
  function e(i, a, r) {
    ...
    let { height: d, marginTop: u } = Vn(t, a, l, 30, i, r), c = d, h = 0;
    switch (o) {
      case "snet":
      case "fnet":
      case "mso":
  ...
  return { extend: function(n) {
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        var l;
        for (var d in o) {
          var u = o[d], c = a.getTask(u.id);
          if (!c.unscheduled) {
            var h = this._drag_task_coords(c, u), _ = a.posFromDate(new Date(a.getState().min_date)), f = a.posFromDate(new Date(a.getState().max_date));
            if (h.end + s > f) {
              var k = f - h.end;
              (k < l || l === void 0) && (l = k);
            } else if (h.start + s < _) {
        ...
        if (s.mode) {
          ...
          if (this._handlers[s.mode]) {
            if (s.mode === l.drag_mode.move) {
              ...
              let m;
              if (v !== void 0 && (c = v), this._update_item_on_move(c, s.id, s.mode, s, o), v === void 0) {
              ...
              for (var b in _) {
                var g = _[b];
                f && g.id != s.id && (a._bulk_dnd = !0), this._update_item_on_move(c, g.id, g.mode, g, o, m);
              }
              a._bulk_dnd = !1;
...
const Nr = { init: function(t) {
  ...
  var i = function(r) {
    ...
    return { getDataRender: function(s) {
      ...
      return { addTaskLayer: function(d) {
        ...
        const u = Kn();
        return typeof d == "function" ? d = { renderer: { render: d, getVisibleRange: u } } : d.renderer && !d.renderer.getVisibleRange && (d.renderer.getVisibleRange = u), d.view = "timeline", d && d.renderer && (d.renderer.getRectangle || d.renderer.isInViewPort || (d.renderer.isInViewPort = Xn)), l.addLayer(d);
  ...
  return t.ext.inlineEditors = a, t.ext._inlineEditors = a, a.init(t), { factory: e, mouseEvents: Ua.init(t), layersApi: i.init(), render: { gridLine: function() {
    return /* @__PURE__ */ function(r) {
      ...
      }, update: null, getRectangle: ie, isInViewPort: vr, getVisibleRange: Z, onrender: function(o, s, l) {
    ...
    return /* @__PURE__ */ function(r) {
      ...
      }, getRectangle: He, getVisibleRange: Z, prepareData: pr };
    }(t);
  }, taskBar: function() {
    return function(r) {
      return { render: be(r), update: null, isInViewPort: It, getVisibleRange: Z };
    }(t);
    ...
    return function(r) {
      ...
      }, isInViewPort: It, getVisibleRange: Z };
    }(t);
    ...
    return /* @__PURE__ */ function(r) {
      function o(s, l, d) {
        const u = document.createElement("div"), c = r.getTaskPosition(s, s.deadline, s.deadline), { height: h, marginTop: _ } = Vn(r, l, c, 20, s, d);
        let f = h;
      ...
      function o(s, l, d, u, c) {
        ...
        switch (r.config.baselines.render_mode) {
          ...
          case "individualRow":
            ...
            break;
          default:
            $ = 1, c ? (g = ne(r, u, s).maxHeight, b ? g >= v ? $ = (g - p) / 2 - 1 - b : (p = _n(g), m = k.top, $ = Math.abs(p - g) / 2, b = 0) : (g > p && ($ = (g - p) / 2 - 1), $ -= b), s.bar_height || ($ -= 1)) : (s.bar_height && k.rowHeight >= s.bar_height && ($ = (k.rowHeight - s.bar_height) / 2 - 1), $ += b, s.bar_height || ($ += 2), f && ($ += 1));
        }
        let S = k.top + g + 1 - b;
    ...
    return function(r) {
      ...
      return { render: function(u, c, h, _) {
        ...
        for (var y = g.start; y <= g.end; y++) {
          var w = b[y];
          if (m[y] = !1, w) if (Vt(y, v, f, r)) if (s[u.id] && s[u.id][y]) s[u.id] && s[u.id][y] && !s[u.id][y].parentNode && c.appendChild(s[u.id][y]);
          else {
            var x = l(u, w, k, 0, h);
...
function Pr(t) {
  ...
  function c() {
    ...
    if (_) {
      ...
      var k = J(_), v = r.x - k.x, b = r.y - k.y + window.scrollY, g = e ? 0 : h(v, k.width, a.x - k.x), m = h(b, k.height, a.y - k.y + window.scrollY), p = t.getScrollState(), y = p.y, w = p.inner_height, x = p.height, $ = p.x, S = p.inner_width, T = p.width;
      ...
      var m = function(S) {
        ...
        M = I.checkbox, D = I.input, C = M.checked, E = D.value.trim(), I.filterApplied = !!E, t.getState().lightbox && (v = t.getLightboxValues()), T = function(L, P, N, z) {
          ...
          if (z) {
            ...
            for (var st = {}, vt = 0; vt < F.length; vt++) st[F[vt].resource_id] = !0;
            O = function(q) {
...
function Fr(t) {
  var n = function() {
    ...
    return W(p, m), p.prototype.render = function($) {
      ...
      function H() {
        var V = w.call(g, $, E), j = x.call(g, $, E), st = g.calculateEndDate({ start_date: V, duration: j, task: T }), vt = g.templates.task_end_date || g.templates.task_date;
        z.innerHTML = vt(st);
      }
      function F(V) {
        var j = P.value;
    ...
    function w(S, T, E, C) {
      ...
      var F, V, j, st = H.getElementsByTagName("select"), vt = H.getElementsByTagName("input"), q = vt[1], St = [vt[0], vt[2]], Ht = H.getElementsByTagName("span")[0], Tt = C._time_format_order;
      function $t() {
        var kt = x.call(g, H, C), X = $.call(g, H, C), ii = g.calculateEndDate({ start_date: kt, duration: X, task: E }), ai = g.templates.task_end_date || g.templates.task_date;
        Ht.innerHTML = ai(ii);
      }
      function qt(kt) {
        var X = q.value;
      ...
      H.querySelector(".baseline_delete_button").onclick = function(kt) {
        ...
        qt(1 * g.config.duration_step);
      }, g), st[0].onchange = $t, st[1].onchange = $t, st[2].onchange = $t, st[3] && (st[3].onchange = $t), q.onkeydown = g.bind(function(kt) {
        var X;
  ...
  if (!bt.isNode) {
    ...
    t.$ui = e.factory, t.$ui.layers = e.render, t.$mouseEvents = e.mouseEvents, t.$services.setService("mouseEvents", function() {
      ...
      for (var d in i._waiAria = { getAttributeString: function(u) {
        ...
        c.setAttribute("role", "img"), c.setAttribute("aria-label", o(k));
...
Q.gantt = Ur, Q.Gantt = Be, Be.plugin((t) => {
  Ye() || setTimeout(() => {
    const n = ["Your evaluation period for dhtmlxGantt has expired.", "Please contact us at <a href='mailto:contact@dhtmlx.com?subject=dhtmlxGantt licensing' target='_blank'>contact@dhtmlx.com</a> or visit", "<a href='https://dhtmlx.com/docs/products/dhtmlxGantt' target='_blank'>dhtmlx.com</a> in order to obtain a license."].join("<br>");
    if (!(typeof 1747550704000 > "u")) {
      var e, i;
      setInterval(() => {
        Date.now() - 1747550704000 > 27648e5 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
